...
SUMINOE = "住之江［成績］"  # 住之江［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        suminoey = datetime.date.suminoey()
        yesterday = suminoey - datetime.timedelta(days=1)
