...
GAMAGORI = "蒲　郡［成績］"  # 蒲　郡［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        gamagoriy = datetime.date.gamagoriy()
        yesterday = gamagoriy - datetime.timedelta(days=1)
