...
WAKAMATSU = "若　松［成績］"  # 若　松［成績］（mbrace見出し）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        wakamatsuy = datetime.date.wakamatsuy()
        yesterday = wakamatsuy - datetime.timedelta(days=1)
