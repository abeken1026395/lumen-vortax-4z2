...
FUKUOKA = "福　岡［成績］"  # 福　岡［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        fukuokay = datetime.date.fukuokay()
        yesterday = fukuokay - datetime.timedelta(days=1)
