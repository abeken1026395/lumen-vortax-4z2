...
BIWAKO = "びわこ［成績］"  # びわこ［成績］（mbrace見出し）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        biwakoy = datetime.date.biwakoy()
        yesterday = biwakoy - datetime.timedelta(days=1)
