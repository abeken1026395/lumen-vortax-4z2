...
ASHIYA = "芦　屋［成績］"  # 芦　屋［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        ashiyay = datetime.date.ashiyay()
        yesterday = ashiyay - datetime.timedelta(days=1)
