...
HAMANAKO = "浜名湖［成績］"  # 浜名湖［成績］（mbrace見出し・3文字名は推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        hamanakoy = datetime.date.hamanakoy()
        yesterday = hamanakoy - datetime.timedelta(days=1)
