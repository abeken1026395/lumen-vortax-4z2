...
MARUGAME = "丸　亀［成績］"  # 丸　亀［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        marugamey = datetime.date.marugamey()
        yesterday = marugamey - datetime.timedelta(days=1)
