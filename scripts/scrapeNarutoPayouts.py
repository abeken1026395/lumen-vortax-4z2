...
NARUTO = "鳴　門［成績］"  # 鳴　門［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        narutoy = datetime.date.narutoy()
        yesterday = narutoy - datetime.timedelta(days=1)
