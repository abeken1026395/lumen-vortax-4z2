...
MIKUNI = "三　国［成績］"  # 三　国［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        mikuniy = datetime.date.mikuniy()
        yesterday = mikuniy - datetime.timedelta(days=1)
