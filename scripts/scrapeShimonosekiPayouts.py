...
SHIMONOSEKI = "下　関［成績］"  # 下　関［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        shimonosekiy = datetime.date.shimonosekiy()
        yesterday = shimonosekiy - datetime.timedelta(days=1)
