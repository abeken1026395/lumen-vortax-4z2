...
EDOGAWA = "江戸川［成績］"  # 江戸川［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        edogaway = datetime.date.edogaway()
        yesterday = edogaway - datetime.timedelta(days=1)
