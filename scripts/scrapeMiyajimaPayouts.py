...
MIYAJIMA = "宮　島［成績］"  # 宮　島［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        miyajimay = datetime.date.miyajimay()
        yesterday = miyajimay - datetime.timedelta(days=1)
