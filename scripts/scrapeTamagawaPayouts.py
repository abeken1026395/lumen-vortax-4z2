...
TAMAGAWA = "多摩川［成績］"  # 多摩川［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        tamagaway = datetime.date.tamagaway()
        yesterday = tamagaway - datetime.timedelta(days=1)
