...
AMAGASAKI = "尼　崎［成績］"  # 尼　崎［成績］（mbrace見出し・推定/要ローカル確認）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        amagasakiy = datetime.date.amagasakiy()
        yesterday = amagasakiy - datetime.timedelta(days=1)
