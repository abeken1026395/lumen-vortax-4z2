...
TOKONAME = "常　滑［成績］"  # 常　滑［成績］（mbrace見出し）
SEISEKI = "［成績］"                    # ［成績］
PAY = "払戻金"                              # 払戻金
...
def main():
    ...
    if ym:
        ...
        tokonamey = datetime.date.tokonamey()
        yesterday = tokonamey - datetime.timedelta(days=1)
